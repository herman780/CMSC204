...
public class NotationStackTest {
	...
	public Double aA = 33.0;
	public Double bB = 56.0;
	public Double cC = 75.0;
	public Double dD = 84.3;
	public Double eE = 90.5;
	public Double fF = 100.4;
	...
	public void testPopStudent() {
		try {
			...
			assertEquals(bB, doubleS.pop());
			assertEquals(aA, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
	...
	public void testToStringStudent() {
		assertEquals("33.056.075.0", doubleS.toString());
		doubleS.push(dD);
		assertEquals("33.056.075.084.3", doubleS.toString());
		doubleS.push(eE);
		assertEquals("33.056.075.084.390.5", doubleS.toString());
	}
