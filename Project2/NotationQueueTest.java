...
public class NotationQueueTest {
	...
	public Double aA = 67.5;
	public Double bB = 89.3;
	public Double cC = 78.2;
	public Double dD = 23.7;
	public Double eE = 12.6;
	public Double fF = 45.8;
	@Before
	...
	public void testDequeueStudent() {
		try {
			assertEquals(aA, doubleQ.dequeue());
			assertEquals(bB, doubleQ.dequeue());
			assertEquals(cC, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("Should have caused an QueueUnderflowException", false);
		}
		catch (QueueUnderflowException e){
			assertTrue("Should have caused an QueueUnderflowException", true);
		}
		catch (Exception e){
			assertTrue("Should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertTrue("Should have caused an QueueOverflowException", true);
		}
		catch (Exception e){
			assertTrue("Should have caused an QueueOverflowException", false);
		}
	...
	public void testToStringStudent() {
		assertEquals("67.589.378.2", doubleQ.toString());
		doubleQ.enqueue(dD);
		assertEquals("67.589.378.223.7", doubleQ.toString());
		doubleQ.enqueue(eE);
		assertEquals("67.589.378.223.712.6", doubleQ.toString());
	}
